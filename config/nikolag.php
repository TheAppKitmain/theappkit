    ...
    'connections' => [
        ...
        */
        'square' => [
            ...
            */
            'user' => [
                'namespace'  => env('SQUARE_USER_NAMESPACE', 'App\Models\Template\Food_Delivery\FoodAppUser'),
            ...
            */
            'order' => [
                'namespace'          => env('SQUARE_ORDER_NAMESPACE', 'App\Models\Template\Food_Delivery\FoodOrder'),
