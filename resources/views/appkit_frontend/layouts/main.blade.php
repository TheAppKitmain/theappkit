      ...
      <header>
                  ...
                  <div class="col-md-12">
                     <nav class="navbar navbar-expand-lg navbar-light navbar-custom">
                        <a class="navbar-brand" href="{{ URL::to('/') }}">
                            ...
                            <img class="open-menu" src="{{asset('images/logo-no-background.png')}}" alt=""/>
         ...
         <div class="mob-navbar ">
            <div class="navbar navbar-custom">
               <a  href="{{ URL::to('/') }}"><img class="moblogo" src="{{asset('images/logo-no-background.png')}}" alt="Logo"/></a>
...
<footer>
         <div class="container">
            <div class="row below-footer">
               ...
               <div class="col-md-4 bottom-f-content">
                  <h4>Company</h4>
                  <ul class="footerlinks">
