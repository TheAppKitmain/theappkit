...
@section('content')
         ...
         <div class="container">
            <div class="row ">
               <div class="col-md-7 left-banner-text">
                  <h2> Turn your App idea into a reality!</h2>
                  ...
                  <div class="btn-container mt-5 create_top_btn">
               ...
               <div class="col-md-5">
                  <div class="video-box-banner">
                     <div class="video-box-container">
                        <img class="bnrph" src="images/hero-graphic@2x.png">
               ...
               <div class="btn-container mt-5 create_bottom_btn">
                     <a class="btn-color btn-style" href="{{ URL::to('buildapp') }}">Create an App</a>
                  </div>
            </div>
         </div>
      ...
      <!-- app-showcase-sec -->
      <div class="   ">
      <img class="w-100 appkit_front_banner" src="images/mixed-men-and-women-posing-over-colorful-backgroun-2022-02-08-02-17-58-utc-1.jpg">
      </div>
         ...
         <div class="container-fluid p-0">
            <div class="row no-gutters justify-c">
               <div class="col-md-6 left-onlinestore-text">
                  ...
                  <div class="btn-container mt-5 start_top_btn">
               ...
               <div class="col-md-6 ">
                  <!-- <div class="onlinestore-box-banner"> -->
                     <!-- <div class="onlinestore-box-container"> -->
                        <img class="onlinestoreimg" style ="width:100%;"src="images/3360bd57d9c6895f8f24999cac8a39f8.webp"alt="">
               ...
               <div class="btn-container mt-5 start_bottom_btn">
         ...
         <div class="container-fluid p-0">
            <div class="row no-gutters justify-c">
               <div class="col-md-6 left-reateapp">
                  <div class="onlinestore-box-banner">
                        <img class="ocrpimg" src="images/Untitled design.png"alt="">
            ...
            <div class="row no-gutters justify-c">
			   <div class="col-md-6 left-onlinestore-text">
                  ...
                  <div class="btn-container mt-5">
                     ...
                     <form method ="GET" action="{{route('register')}}">
                            <input type="hidden" id="name" name="name" value="custom">
                               <a href="javascript:void(Tawk_API.toggle())" class="btn-color btn-style lt_tk lets_top_btn">Let's talk</a>
                     </form>
                  </div>
               </div>
               <div class="col-md-6">
               ...
               <form method ="GET" action="{{route('register')}}" class="lt_talk">
                            <input type="hidden" id="name" name="name" value="custom">
                               <a href="javascript:void(Tawk_API.toggle())" class="btn-color btn-style lt_tk lets_bottom_btn">Let's talk</a>
                     </form>
            </div>
         </div>
      </div>
