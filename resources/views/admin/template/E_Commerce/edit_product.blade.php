                                    ...
                                    <div class="col-md-4 right-prd">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="roduct-imgmn-img-box">
                                                ...
                                                <a href="{{route('theme.deleted_product_image',[$product->id,'product_display_image_1'])}}" class="btndelete deletebtn-products" ><i class="fa fa-trash-o" aria-hidden="true"></i></a>
                                            ...
                                            <div class="roduct-imgmn-img-box">
                                                ...
                                                <a href="{{route('theme.deleted_product_image',[$product->id,'product_display_image_2'])}}" class="btndelete deletebtn-products" ><i class="fa fa-trash-o" aria-hidden="true"></i></a>
                                            ...
                                            <div class="roduct-imgmn-img-box">
                                                ...
                                                <a href="{{route('theme.deleted_product_image',[$product->id,'product_display_image_3'])}}" class="btndelete deletebtn-products" ><i class="fa fa-trash-o" aria-hidden="true"></i></a>
