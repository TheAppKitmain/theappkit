            ...
            <div class="main-container-inner ">
               <div class="container-fluid">
                  <div class="row">
                     ...
                     @if(count($products) == 0)
                        <a id="savebtn_theme" data-redirect-url="{{ URL::to('theme/theme_settings') }}" class="btn savebtn_add_product">Add Products</a>
                     @else
...
<script>
$("#savebtn_theme").click(function(){
   let getRedirectUrl = $(this).attr('data-redirect-url');
    window.location.href= getRedirectUrl;
    sessionStorage.setItem("product", "add_prodcut1");

    var cityName = "add_prodcut";
