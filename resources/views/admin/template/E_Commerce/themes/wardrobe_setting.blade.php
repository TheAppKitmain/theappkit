                           ...
                           <div class="row">
                              <div class="col-md-8 left-product-col">
                                 ...
                                 <div class="row">
                                    ...
                                    <div class="col-md-6">
                                       <div class="form-group">
                                          <label class="pr-label" for="exampleInputEmail1" class="float-right">SKU (Stock Keeping Unit) (Optional) <a class="tooltip-btn" data-tooltip="Track stock inventory and differentiate products" data-tooltip-location="right"> ?</a></label>
                                 ...
                                 <div class="row">
                                    <div class="col-md-12">
                                       <div class="form-group">
                                          <label class="pr-label" for="exampleInputPassword1"><b>Variants</b> <a class="tooltip-btn" data-tooltip="You add variants to a product that comes in more than one option, such as size or color" data-tooltip-location="right"> ?</a></label>
                                       </div>
         ...
         <div class="col-md-8 own-8-col">
            <div class="card-body m-t-20">
               <form  method ="POST" action="{{route('theme.splashscreen')}}" enctype="multipart/form-data" name="splashscreen_form">
                  ...
                  <div class=" form-group">
                     <button class="savebtn savebtn_theme">Save</button>
                  </div>
               </form>
            </div>
         </div>
            ...
            <div class="left-template-bx">
               <div class="card-body m-t-20">
                  ...
                  @endif                     </div>
                     ...
                     <div class=" form-group">
                        <button class="savebtn savebtn_theme" type="submit">Save</button>
                     </div>
                  </form>
               </div>
            </div>
                  ...
                  <div class="row card owncard addprdctrow">
                     ...
                     <h2 class="add_title mb-30">Add Collections <a class="tooltip-btn" data-tooltip="Here you can upload your categories" data-tooltip-location="right"> ?</a></h2>
                        <form class="p-10" method="POST" action="{{route('theme.collections.store')}}" enctype="multipart/form-data" >
                           ...
                           @if(count($collections) > 0)
                           <button class="savebtn savebtn_theme" id="add_prodcut1" onclick="openCity(event, 'add_prodcut')">Save</button>
                           @endif
                           </div>
                        </form>
                     </div>
                  ...
                  <div class="app-preview cor-1-app-preview cor-1-group-container appallscreenpreview">
                     ...
                     <div id="theme-showcase-all" class="app-showcase-main owl-carousel">
                        <div class="theme-slide-itm">
                           <img class="appfrm appscreenprewe " src="{{asset('template/images/ecom-1-myprofile.jpg')}}">
                        </div>
                        <div class="theme-slide-itm">
                           <img class="appfrm appscreenprewe " src="{{asset('template/images/ecom-1-wishlist.jpg')}}">
                        </div>
                        <div class="theme-slide-itm">
                           <img class="appfrm appscreenprewe" src="{{asset('template/images/ecom-1-checkout.jpg')}}">
                        </div>
                        <div class="theme-slide-itm">
                           <img class="appfrm appscreenprewe" src="{{asset('template/images/ecom-1-payment.jpg')}}">
                        </div>
                     </div>
