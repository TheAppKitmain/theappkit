                                 ...
                                 <form id="publishform" method="post" action="{{route('theme.publish_app')}}">
                                    ...
                                    <div class="pricing-box-ch">
                                       ...
                                       <div class="pricing-box-ch-inner">
                                          ...
                                          <input id="planmonth"  type="radio" name="plan_id" value="@if($usercountry->country == 'United Kingdom'){{$themetemplate->monthly_gbp}}@else{{$themetemplate->monthly_usd}}@endif" data-currency="@if($usercountry->country == 'United Kingdom') £ @else $ @endif" data-price="{{number_format((float)$plans_retrieve_3->amount/100, 2, '.', '')}}" checked>
